      ...
      >
        ...
        {navbarSearch ? (
          <Autocomplete
            ...
            grouped={true}
            placeholder="Explore Organic Products..."
            autoFocus={true}
                ...
                >
                  ...
                  >
                    <div className="item-container d-flex">
                      {item.icon ? <IconTag size={17} /> : item.file ? <img src={item.file} height="36" width="28" alt={item.title} /> : item.img ? <img className="rounded-circle mt-25" src={item.img} height="28" width="28" alt={item.title} /> : null}
